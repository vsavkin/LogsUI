    ...
    def index = {
        def lineCollection = new LineCollection([
            line {
                ...
                var name: 'session', type: 'string', value: 'session1', from: 8, to: 17
            },

            line {
                text 'user2 | session2 | 2010-01-01 | some other information'
                var name: 'session', type: 'string', value: 'session2', from: 8, to: 17
            },

            line {
                text 'user3 | session3 | 2010-01-01 | some other information'
                var name: 'session', type: 'string', value: 'session3', from: 8, to: 17
            }
        ])
